    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-8 py-16 space-y-12">
          ...
          <div className="card bg-base-100 border border-base-300 shadow-md transition-transform hover:scale-[1.01] hover:shadow-lg duration-200">
            ...
            <div className="card-body px-4 sm:px-8 py-6 md:py-10">
              ...
              <p className="text-base-content/80">
                The Truxor Amphibious Harvester can be fitted with dredging and
                silt pumping tools, allowing for efficient and low-impact silt
                removal from difficult-to-access areas.
              </p>
            </div>
          </div>
      ...
      <div className="card bg-base-100 border border-base-300 shadow-md">
        <div className="card-body px-4 sm:px-8 py-6 md:py-10 space-y-6">
          ...
          <p className="text-base-content/80">
            The silt removed is often a mixture of sediment and water. Depending
            on the site, we use various containment and separation systems to
            ensure clean, efficient removal.
          </p>
      ...
      <ContactUsCard
        ...
        text="For more information or to discuss a specific project, please contact us directly. You can also view our full"
