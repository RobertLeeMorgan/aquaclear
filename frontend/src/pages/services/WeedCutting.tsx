    ...
    <div className="bg-base-200 py-12">
      <div className="max-w-6xl mx-auto px-6 space-y-16">
        ...
        <div className="card bg-base-100 border border-base-300 shadow-md">
          <div className="card-body md:p-10 space-y-4">
            <h2 className="card-title text-2xl text-primary">Our Service</h2>
            <p className="text-base-content/80 leading-relaxed">
              Excessive aquatic weed growth can reduce flow, increase flood
              risk, and suppress native habitats. We provide mechanical cutting,
              collection, and long-term management solutions to restore open
              water and balance aquatic ecosystems.
            </p>
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-base-content/90 leading-relaxed text-center max-w-2xl mx-auto">
              ...
              fisheries and reservoirs, fitted with knives, rakes and grab
              buckets for precise cutting and lifting to depths of 2m.
            </p>
          </div>
