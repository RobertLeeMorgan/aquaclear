      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          <img
            ...
            className="rounded-2xl shadow-md object-cover h-48 w-full justify-self-center hidden sm:block"
          />
          <img
            src="/images/projects/reed2.webp"
            alt="Reed cutting in progress"
            className="rounded-2xl shadow-md object-cover h-48 w-full justify-self-center"
          />
        </div>
      </div>
      {/* ---------------- EXAMPLES ---------------- */}
