        ...
        <div className="grid md:grid-cols-2 gap-6 p-6 items-center">
          <div className="space-y-3">
            ...
            <p className="text-base-content/80 leading-relaxed">
              ...
              semi-permeable membranes in place of de-silting bags — ideal when
              the terrain isn’t level enough. These membranes trapped silt while
              allowing water to drain naturally. Once dry, the silt was removed
              or left to green over during the summer months.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <img
              src="/images/projects/teram1.webp"
              alt="Silt membrane setup"
              className="rounded-xl object-cover h-52 w-full shadow-sm"
            />
            <img
              src="/images/projects/teram2.webp"
      ...
      <div className="card bg-base-100 border border-base-300 shadow-md">
        <div className="grid md:grid-cols-2 gap-6 p-6 md:flex-row-reverse items-center">
          <div className="order-2 md:order-1 space-y-3">
            ...
            <p className="text-base-content/80 leading-relaxed">
              In partnership with a major water utility, silt was pumped into a
              holding tank and processed into a dry, compact “silt cake.” This
              minimized waste volume and allowed for cleaner handling and
      ...
      <div className="card bg-base-100 border border-base-300 shadow-md">
        <div className="grid md:grid-cols-2 gap-6 p-6 items-center">
          <div className="space-y-3">
            ...
            <p className="text-base-content/80 leading-relaxed">
              At a northern reserve, we used a silt pump with a permeable Teram
              membrane placed over a soil and timber bund. This increased water
              depth while maintaining flow in the watercourse. Once full, the
              bunds were left to drain, then greened naturally through the
              warmer months, enhancing biodiversity.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <img
      ...
      <div className="card bg-base-100 border border-base-300 shadow-md">
        <div className="grid md:grid-cols-2 gap-6 p-6 md:flex-row-reverse items-center">
          <div className="order-2 md:order-1 space-y-3">
            ...
            <p className="text-base-content/80 leading-relaxed">
              At a pond site in Pembrokeshire, silt and reed buildup had choked
              the watercourse. Using a combination of silt pumping and
              dewatering bags, we gradually filtered out excess material. Once
              drained, a grab bucket was used to remove a central “silt island,”
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            />
            <img
              src="/images/projects/pembs2.webp"
              alt="Dewatering bags on site"
              className="rounded-xl object-cover h-52 w-full shadow-sm"
            />
            <img
              src="/images/projects/pembs3.webp"
              alt="Grab bucket removing silt"
              className="rounded-xl object-cover h-52 w-full shadow-sm hidden md:block"
            />
            <img
              src="/images/projects/pembs4.webp"
      ...
      <div className="card bg-base-100 border border-base-300 shadow-md">
        <div className="p-6 space-y-6">
          ...
          <p className="text-base-content/80 leading-relaxed text-center max-w-3xl mx-auto">
            ...
            water quality. The diff view below shows the transformation clearly.
          </p>
          <BeforeAfter
      ...
      <div className="card bg-base-100 border border-base-300 shadow-md">
        <div className="grid md:grid-cols-2 gap-6 p-6 items-center">
          <div className="space-y-3">
            ...
            <p className="text-base-content/80 leading-relaxed">
              This private pond project in Preston involved pumping silt behind
              a geotextile barrier set on unused land. After draining and
              setting, the membrane was removed and the silt left to green over,
              restoring the pond’s natural balance and clarity.
            </p>
          </div>
          <div>
            <img
              src="/images/projects/preston.webp"
