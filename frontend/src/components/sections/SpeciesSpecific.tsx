    ...
    return (
        <section className="space-y-6 ">
                    ...
                    <div className="collapse-content space-y-4 leading-relaxed">
                      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 items-center gap-6 lg:gap-8">
                        <p className="text-base-content/90">
                          ...
                          Rising temperatures increase growth, with blooms peaking in
                          spring and summer. Surface mats absorb sunlight, warming the
                          water and accelerating growth, while nutrient runoff from
                          agriculture promotes rapid spreading.
                        </p>
                        <img
                      ...
                      <div className="space-y-3 pt-3">
                        ...
                        <p className="text-base-content/90">
                          ...
                          preserving oxygenating plants below, restoring water clarity
                          and balancing the aquatic environment.
                        </p>
                        <p className="text-base-content/90">
                          Silt removal controls nutrients such as nitrates and
                          phosphates, reducing future bloom risk and providing a
                          longer-term algae management solution.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="collapse-content space-y-4 leading-relaxed">
                      ...
                      <div className="space-y-3 pt-3">
                        ...
                        <p className="text-base-content/90">
                          ...
                          regrowth. Precision cutting maintains habitats while keeping
                          water flowing.
                        </p>
                        <p className="text-base-content/90">
                          Grip and grab buckets remove rhizomes from blocked or
                          encroached areas, providing longer-term control.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="collapse collapse-arrow join-item border border-base-300 bg-base-100 transition-all duration-300">
                    ...
                    <div className="collapse-content space-y-4 leading-relaxed">
                      <p className="text-base-content/90">
                        Water lilies are common in UK ponds and lakes. They provide
                        habitat but can dominate water surfaces, outcompeting native
                      ...
                      <p className="text-base-content/90">
                        Precision cutting clears selected areas while maintaining
                        ecological balance. Large rhizome systems may require root
                    ...
                    <div className="collapse-content space-y-4 leading-relaxed">
                      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 items-center gap-6 lg:gap-8">
                        <p className="text-base-content/90">
                          ...
                          waterways are already infested and require regular maintenance
                          to keep them at bay.
                        </p>
